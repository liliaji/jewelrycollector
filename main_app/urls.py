...
from .views import Home, JewelryList, JewelryDetail, FeedingListCreate, FeedingDetail, ToyList, ToyDetail, AddToyToJewelry, RemoveToyFromJewelry, CreateUserView, LoginView, VerifyUserView
